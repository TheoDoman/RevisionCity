...
const tiers = [
  {
    ...
    description: 'Get a taste — no credit card needed',
    features: [
  ...
  },
  {
    ...
    description: 'The complete toolkit serious students use to ace IGCSEs',
    features: [
      'All 9 IGCSE subjects — fully covered',
      'AI Test Generator — build custom exams in seconds',
      'Unlimited subtopics, quizzes & flashcards',
      'Full notes, mind maps & summary sheets',
      'Complete bank of practice & exam-style questions',
      'Detailed progress tracking — see exactly where you stand',
    ],
    notIncluded: [],
    cta: 'Get Pro',
    icon: Sparkles,
  ...
  },
  {
    ...
    description: 'Everything in Pro, plus a personal AI coach working for you around the clock',
    features: [
      'Everything in Pro',
      'AI Tutor — instant answers, any time of day or night',
      'Personalised study plans built around your weak spots',
      'Smart weak area analysis — study smarter, not harder',
      'Priority support — skip the queue every time',
